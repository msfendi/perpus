...
<head>
  ...
  <title>Bank PTIK | Dashboard</title>
      ...
      <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown user-menu">
          <a href="#" class="nav-link dropdown-toggle" data-toggle="dropdown">
            ...
            <span class="d-none d-md-inline"><?= $this->fungsi->user_login()->nama_karyawan; ?></span>
          </a>
          <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
            ...
            <li class="user-header bg-primary">
              ...
              <p>
                <?= $this->fungsi->user_login()->nama_karyawan; ?>
                <small> <?= $this->fungsi->user_login()->nama_divisi; ?></small>
              </p>
            </li>
            <!-- Menu Body -->
            <!-- <li class="user-body">
      ...
      <div class="sidebar">
        ...
        <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
            ...
            <!-- Untuk dilakukan pengecekan apabila yg login adalah operator dan admin nav akan muncul, jika member tidak muncul -->
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <li class="nav-item">
                  <a href="<?= base_url() ?>presensi/data_kehadiran" class="nav-link">
                ...
                <?php if ($this->session->userdata('level') == 1 || $this->session->userdata('level') == 2) : ?>
                  <li class="nav-item">
                    <a href="<?= base_url() ?>presensi/rekap_kehadiran" class="nav-link">
                      <i class="fas fa-chart-area nav-icon"></i>
                      <p>Rekap Kehadiran</p>
                    </a>
                  </li>
            ...
            <li class="nav-item">
              ...
              <ul class="nav nav-treeview">
                ...
                <?php endif ?>
                <li class="nav-item">
                  <a href="<?= base_url('cuti/data_cuti') ?>" class="nav-link">
                    <i class="fas fa-chart-area nav-icon"></i>
                    <p>Data Cuti</p>
                  </a>
                </li>
                <?php if ($this->session->userdata('level') == 1 || $this->session->userdata('level') == 2) : ?>
                  <li class="nav-item">
                    <a href="<?= base_url('cuti/rekap_cuti') ?>" class="nav-link">
                      <i class="fas fa-chart-area nav-icon"></i>
                      <p>Rekap Cuti</p>
                    </a>
                  </li>
            ...
            <?php if ($this->session->userdata('level') == 1 || $this->session->userdata('level') == 2) : ?>
              <li class="nav-item">
                <a href="<?= base_url() ?>jurnal/rekap_jurnal" class="nav-link">
                  <i class="fas fa-book nav-icon"></i>
                  <p>Rekap Jurnal</p>
                </a>
              </li>
            ...
            <?php if ($this->session->userdata('level') == 3) : ?>
              <li class="nav-item">
                <a href="<?= base_url() ?>rekap/grafik/<?= $this->fungsi->user_login()->id_karyawan ?>" class="nav-link">
                  <i class="nav-icon fas fa-chart-pie"></i>
                  <p>Infografis</p>
                </a>
              </li>
            ...
            <li class="nav-item">
              <a href="<?= base_url() ?>akun/setting" class="nav-link">
                <i class="nav-icon fas fa-tachometer-alt"></i>
                <p>
                  Akun
                </p>
